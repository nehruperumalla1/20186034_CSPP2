            ...
            case "I"://This case will be executed for Integer type list
                ...
                while (stdin.hasNext()) {
                    ...
                    switch (tokens[0]) {
                        ...
                        break;
                        case "indexOf":
                        System.out.println(listInteger.indexOf(Integer.
                            parseInt((tokens[1]))));
                        break;
                        case "get":
                        System.out.println(listInteger.get(Integer.
                            parseInt(tokens[1])));
                        break;
                        case "contains":
                        System.out.println(listInteger.contains(Integer.
                            parseInt((tokens[1]))));
                        break;
                        default:
                    }
            ...
            case "F"://This case will be executed for Float type list
                ...
                while (stdin.hasNext()) {
                    ...
                    switch (tokens[0]) {
                        ...
                        break;
                        case "indexOf":
                        System.out.println(listFloat.indexOf(Float.
                            parseFloat(tokens[1])));
                        break;
                        case "get":
                        System.out.println(listFloat.get(Integer.
                            parseInt(tokens[1])));
                        break;
                        case "contains":
                        System.out.println(listFloat.contains(Float.
                            parseFloat(tokens[1])));
                        break;
                        default:
                    }
            ...
            case "C"://This case will be executed for Character type list
                ...
                while (stdin.hasNext()) {
                    ...
                    switch (tokens[0]) {
                        ...
                        break;
                        case "contains":
                        System.out.println(listCharacter.contains(tokens[1].
                            charAt(0)));
                        break;
                        default:
                    }
            ...
            case "D"://This case will be executed for Double type list
                ...
                while (stdin.hasNext()) {
                    ...
                    switch (tokens[0]) {
                        ...
                        break;
                        case "indexOf":
                        System.out.println(listDouble.indexOf(Double.
                        ...
                        break;
                        case "contains":
                        System.out.println(listDouble.contains(Double.
                            parseDouble(tokens[1])));
                        break;
                        default:
                    }
